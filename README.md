...
- Qual a distribuição das bolsas por gênero?
...
- Modalidade da bolsa (Presencial/EAD)
- Raça/Cor e Sexo do beneficiário
- Nome do curso e da Instituição de Ensino
- Localização (UF e Município)

## Como visualizar o projeto
Você pode acessar o código completo e as visualizações diretamente pelo Google Colab:
[Link para o Notebook no Colab](https://colab.research.google.com/drive/1k6dTOyCsqWiQ_fDNoNR6ZO2e-2IgriUI?usp=sharing)
